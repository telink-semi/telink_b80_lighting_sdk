...
const unsigned char key_table[KB_ROW_NUM][KB_COL_NUM] = {//按键表格
		{ KEY_LUMINANT_INCREASE, KEY_CHROMA_DECREASE, KEY_LIGHT_ON_GROUP1,KEY_LIGHT_OFF_GROUP1,KEY_LIGHT_ON_ALL},
		{ KEY_CHROMA_INCREASE, KEY_LUMINANT_DECREASE, KEY_LIGHT_ON_GROUP2,KEY_LIGHT_OFF_GROUP2,KEY_LIGHT_OFF_ALL},
