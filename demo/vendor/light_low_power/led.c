...
_attribute_data_retention_ unsigned short led_lumina_cur;
_attribute_data_retention_ unsigned short led_lumina_target;
_attribute_data_retention_ unsigned short led_chroma_cur;
_attribute_data_retention_ unsigned short led_chroma_target;
_attribute_data_retention_ unsigned char  led_state_change_flag;
_attribute_data_retention_ unsigned int   led_change_tick;

_attribute_data_retention_ unsigned char led_flash_cnt;
_attribute_data_retention_ unsigned int  led_flash_tick;
...
{
	led_pwm_control_func(led_lumina_cur, led_chroma_cur);
}
...
{
	return (led_flash_cnt||led_state_change_flag);
}
