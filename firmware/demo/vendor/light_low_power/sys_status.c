...
_attribute_data_retention_ unsigned int  sys_run_tick;
_attribute_data_retention_ unsigned char g_state;

_attribute_data_retention_ unsigned char led_on_cnt;
